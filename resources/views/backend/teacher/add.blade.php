          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="col-sm-12">
                    ...
                    <a class="btn btn-info btn-sm" href="{{url('admin/teacher')}}"><i class="fas fa-list-ul"></i>  View Teacher</a>
                    </div>
                </div><!-- /.col -->
            </div>
            </div>
...
<div class="container-fluid pt-3 border bg-white text-black">
  ...
  <div class="form-group row">
      ...
      <div class="col-xs-3">
        <label for="ex1">Teacher Name</label>
      ...
      <div class="col-xs-2">
        <label for="ex2">Teacher ID</label>
        <input class="form-control" name="teacherid"  type="text" required>
      </div>
      <div class="col-xs-2">
